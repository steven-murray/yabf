...
if __name__ == "__main__":
    ...
    lk_lo = Chi2(
        ...
        params=(
            Param(
                'logsigma_lo', determines=("sigma",), min=-10, max=1,
        ...
        components=(
            Poly(
                ...
                x=x,
                params=(
                    Param('p0_lo', fiducial=4, min=-10, max=10, ref=stats.norm(4, 1),
                          determines=("p0", )),
                    p1, p2 , p3
                )
            ),
    ...
    lk_hi = Chi2(
        ...
        params=(
            Param(
                'logsigma_hi', determines=("sigma", ), min=-10, max=1,
                parameter_mappings=[np.exp, ]
            ),
        ),
        components=(
            Poly(
                ...
                x=x_hi,
                params=(
                    Param('p0_hi', fiducial=4, min=-10, max=10, ref=stats.norm(4, 1),
                          determines=('p0',)),
                    p1, p2 , p3,
                )
            ),
    ...
    if mpi.am_single_or_primary_process:
        fig, ax = plt.subplots(2, 1, sharex=True, gridspec_kw={"hspace": 0.05}, figsize=(15, 10))
