...
version = _version('yabf')
# The full version, including alpha/beta/rc tags.
release = _version('yabf')
...
latex_documents = [
  ('index', 'yabf.tex', u'yabf Documentation',
...
man_pages = [
    ('index', 'yabf', u'yabf Documentation',
     [u'Steven Murray'], 1)
]
...
texinfo_documents = [
  ('index', 'yabf', u'yabf Documentation',
   u'Steven Murray', 'yabf', 'One line description of project.',
   'Miscellaneous'),
]
